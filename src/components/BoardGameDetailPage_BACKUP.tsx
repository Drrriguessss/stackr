  ...
  return (
    <div className="bg-[#0f0e17] min-h-screen pb-20 font-system">
      {loading ? (
        ...
        <div>
          {/* Hero Section - Purple Gradient with Background Image */}
          <div className="relative min-h-[400px] overflow-hidden">
            {/* Background Image Layer - Plus visible */}
            <div 
            ...
            >
              <img
                ...
                style={{
                  opacity: 0.4,  // Augmenté de 0.25 à 0.4
                  filter: 'brightness(1.1)',  // Pas de blur, juste luminosité
                }}
                onError={(e) => {
            ...
            {/* Purple Gradient Overlay - Beaucoup plus transparent */}
            <div 
              className="absolute inset-0"
              style={{ 
            ...
            <div className="flex items-center justify-between p-5 relative z-10">
              <button
                onClick={onBack}
                className="w-10 h-10 bg-white/10 border border-white/20 rounded-xl text-white flex items-center justify-center backdrop-blur-xl transition-all duration-200 active:scale-95 hover:bg-white/20"
              >
                <ArrowLeft size={20} />
              </button>
              
              {/* URL Bar Style */}
              <div className="flex-1 mx-4 px-4 py-2 bg-white/10 border border-white/20 rounded-full text-center text-sm text-white backdrop-blur-xl">
                stackr.app
              </div>
            ...
            {/* Game Info Container */}
            <div className="px-5 pb-10 relative" style={{ zIndex: 10 }}>
